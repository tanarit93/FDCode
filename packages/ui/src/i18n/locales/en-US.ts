...
const enUS: Record<string, string> = {
  ...
  "login.apiKey.placeholderOptional": "sk-... (leave empty for a local LLM)",
  "login.apiKey.label": "API Key",
  "login.apiKey.baseUrlLabel": "Base URL",
  "login.apiKey.modelLabel": "Default model",
  "login.apiKey.invalidBaseUrl": "Enter a valid Base URL starting with http:// or https://.",
